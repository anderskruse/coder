...
class WelcomeBanner(Static):
    ...
    def _initialize_static_line_suffixes(self) -> None:
        self._static_line1_suffix = (
            f"{self.LOGO_TEXT_GAP}[b]KK-code v{__version__}[/]"  #### KK-code altercation
        )
    ...
    def _build_line(self, line_idx: int, color: str) -> str:
        ...
        patterns = [
            #### KK-code altercation BEGIN ####
            f"[{color}]{B}[/]{S}{S}[{color}]{B}[/]{S}[{color}]{B}[/]{S}{S}[{color}]{B}[/]{S}{self._static_line1_suffix}",
            f"[{color}]{B}[/]{S}[{color}]{B}[/]{S}{S}[{color}]{B}[/]{S}[{color}]{B}[/]{S}{S}{self._static_line2_suffix}",
            f"[{color}]{B}{B}[/]{S}{S}{S}[{color}]{B}{B}[/]{S}{S}{S}{self._static_line3_suffix}",
            f"[{color}]{B}[/]{S}[{color}]{B}[/]{S}{S}[{color}]{B}[/]{S}[{color}]{B}[/]{S}",
            f"[{color}]{B}[/]{S}{S}[{color}]{B}[/]{S}[{color}]{B}[/]{S}{S}[{color}]{B}[/]{S}{self._static_line5_suffix}",
            #### KK-code altercation END ####
        ]
