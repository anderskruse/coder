...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by KK-code with the appropriate co-authoring information.\n"  #### KK-code altercation
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        #### KK-code altercation BEGIN ####
        "Generated by KK-code.\n"
        "Co-Authored-By: KK-code <kk-code@kk-code.ai>\n"
...
def get_universal_system_prompt(
    ...
    if config.include_prompt_detail:
        ...
        #### KK-code altercation BEGIN ####
        # Get the active model config to pass tool_format to tools
        try:
