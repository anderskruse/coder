...
class InterruptMessage(Static):
    ...
    def compose(self) -> ComposeResult:
        with Horizontal(classes="interrupt-container"):
            ...
            yield Static(
                "Interrupted · What should KK-code do instead?",  #### KK-code altercation
                markup=False,
...
class ErrorMessage(Static):
    ...
    class Dismissed(Message):
        """Message emitted when the error is dismissed."""
        pass
    ...
    def __init__(self, error: str, collapsed: bool = True) -> None:
        ...
        self._dismiss_button: Button | None = None  #### KK-code altercation
    ...
    def compose(self) -> ComposeResult:
        with Horizontal(classes="error-container"):
            ...
            #### KK-code altercation BEGIN ####
            self._dismiss_button = Button("×", id="dismiss-error", classes="dismiss-button")
            yield self._dismiss_button
            #### KK-code altercation END ####

    def _get_text(self) -> str:
        if self.collapsed:
            return "Error. (ctrl+o to expand, click × to dismiss)"  #### KK-code altercation
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        if event.button == self._dismiss_button:
