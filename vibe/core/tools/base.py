...
class BaseTool[
    ...
    @classmethod
    def get_tool_prompt(cls, active_model: str | None = None, model_config: Any = None) -> str | None:  #### KK-code altercation
 ...
 #### KK-code altercation BEGIN ####
        ...
        Args:
            active_model: The active model name (e.g., "qwen3-coder", "devstral-2").
            model_config: The full ModelConfig object with tool_format, pricing, etc.
                          Tools can use this to customize prompts per model.
