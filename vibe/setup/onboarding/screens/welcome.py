...
WELCOME_PREFIX = "Velkommen til "
WELCOME_HIGHLIGHT = "KK-code"
WELCOME_SUFFIX = " - Lad os komme i gang med opsætningen!"
...
BUTTON_TEXT = "Tryk Enter ↵"

GRADIENT_COLORS = ["#87CEEB", "#5DADE2", "#3498DB", "#2874A6", "#1B4F72"]
